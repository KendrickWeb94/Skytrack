...
import TrustedBrands from "../ui/trusted-by";

export default function Hero() {
  return (
    <section className="w-full min-h-auto font-inter relative hero-sectio bg-primary">
      <div className="w-full min-h-auto pb-12 frame-grid">
        <Navabr />
        <div className="pt-16 md-container w-full">
          <div className="w-full  space-y-6 flex items-start md:items-center justify-center flex-col">
            <p className="px-4 py-1 border text-sm rounded-full border-white text-white bg-white/10">
